...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="p-4 rounded-4 shadow-lg" style="background: linear-gradient(135deg, #02c3c3, #0D1B2A); color: #fff;">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4 mb-3">
            <div class="card card-hover p-3 shadow-sm rounded-4 text-center">
                ...
                <h3 class="mt-2">{{ $teachersCount }}</h3>
                <p class="mb-0 fw-semibold">Total Teachers</p>
            </div>
        </div>
    </div>
