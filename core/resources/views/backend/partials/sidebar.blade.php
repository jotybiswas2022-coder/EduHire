...
<div class="row m-0" style="min-height: 100vh;">
    ...
    <div class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="{{ url('/admin/preferred_class') }}"
                class="{{ request()->is('admin/preferred_class') ? 'active' : '' }}">
             ...
             <li>
                <a href="{{ url('/admin/preferred_subject') }}"
                class="{{ request()->is('admin/preferred_subject') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ url('/admin/teacher_list') }}"
                class="{{ request()->is('admin/teacher_list') ? 'active' : '' }}">
